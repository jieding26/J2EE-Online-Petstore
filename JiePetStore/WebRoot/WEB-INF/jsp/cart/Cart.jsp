...
<stripes:form beanclass="org.mybatis.jpetstore.web.actions.DataMiningActionBean">
	   <div>Recommend Products:</div><stripes:textarea name="resultStr1" style="width:300px;height:100px"/>
</stripes:form>
</div>

  <!--  
  <stripes:link beanclass="org.mybatis.jpetstore.web.actions.RecommendPostActionBean" event="viewRecommend">
