...
public class AccountActionBean extends AbstractActionBean {
  ...
  private static final String RECOMMEND = "/WEB-INF/jsp/catalog/Recommend.jsp";
  
  static final List<String> LANGUAGE_LIST;
  ...
  public Resolution Recommend() {
	    return new ForwardResolution(RECOMMEND);
	  }
